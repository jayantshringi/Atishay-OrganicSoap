...
description: Core UI/UX engineering skill for building highly interactive, spatial, weightless, and glassmorphism-based web interfaces using GSAP, Framer Motion, and 3D CSS.
risk: safe
source: community
...
- The design should lean on GSAP, Framer Motion, 3D CSS transforms, or React-based 3D presentation patterns.
...
- **Animation:** Framer Motion / GSAP + ScrollTrigger for scroll-linked motion
...
- **Scroll Hijacking (Tasteful):** Use scroll-linked triggers to make elements float into view from the Y-axis with slight rotation as the user scrolls.
